 ...
 */
class MenuServicosAdapter(
    private val myDataset: ArrayList<MenuSquareItem>,
    private val onItemClickListener: OnItemClickListener
): RecyclerView.Adapter<MenuServicosAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_menu_square, parent, false) as View
        return MyViewHolder(view)
    }

    /**
     * Método criado para associar a view criada com os dados passados
    ...
    /**
     * Método criado para coletar o tamanho da lista de dados
     * @return myDataset
     */
